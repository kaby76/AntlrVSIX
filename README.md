...
Most of the extension is implemented in C#. (There is a client for VS Code, but I
am not developing it further until the VS2019 extension is more or less complete.)
