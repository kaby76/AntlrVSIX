...
@lexer::members {
	...
	private CommonToken CommonToken(int type, string text)
	{
        ...
        var ct = new CommonToken(type, text);
        ct.StartIndex = start;
        ct.StopIndex = stop;
        ct.Channel = DefaultTokenChannel;
        return ct;
	}
	...
	public override IToken NextToken()
	{
	    ...
	    if (this.InputStream.LA(1) == Eof && Indents.Count != 0)
	    {
...
LINE_COMMENT: COMMENT -> channel(OFF_CHANNEL);

SKIP_
 : ( SPACES | LINE_JOINING ) -> channel(OFF_CHANNEL)
 ;
