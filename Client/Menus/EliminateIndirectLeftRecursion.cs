namespace LspAntlr
{
    ...
    internal class EliminateIndirectLeftRecursion
    {
        ...
        private EliminateIndirectLeftRecursion(AntlrLanguageClient package)
        {
        ...
        public static EliminateIndirectLeftRecursion Instance { get; private set; }
        ...
        private void MenuItemCallback(object sender, EventArgs e, bool split)
        {
            try
            {
                ...
                Dictionary<string, string> changes = alc.CMEliminateIndirectLeftRecursion(ffn, pos);
