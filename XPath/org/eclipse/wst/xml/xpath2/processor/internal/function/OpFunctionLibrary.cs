...
namespace org.eclipse.wst.xml.xpath2.processor.@internal.function
{
	...
	/// </summary>
	public class OpFunctionLibrary : FunctionLibraryImpl
	{

		// XXX should be internal
		public const string XPATH_OP_NS = "http://www.w3.org/TR/2003/WD-xquery-semantics-20030502/";

		/// <summary>
		/// Constructor for OpFunctionLibrary.
		/// </summary>
		public OpFunctionLibrary() : base(XPATH_OP_NS)
		{
