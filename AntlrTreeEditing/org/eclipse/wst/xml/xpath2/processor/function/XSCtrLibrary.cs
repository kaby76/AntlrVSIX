...
namespace org.eclipse.wst.xml.xpath2.processor.function
{
	...
	/// </summary>
	public class XSCtrLibrary : ConstructorFL
	{
		/// <summary>
		...
		/// </summary>
		public XSCtrLibrary() : base(XML_SCHEMA_NS)
		{
			...
			add_abstract_type("anyAtomicType", new AnyAtomicTypeAnonymousInnerClass(this));
		...
		private class AnyAtomicTypeAnonymousInnerClass : AnyAtomicType
		{
			private readonly XSCtrLibrary outerInstance;

			public AnyAtomicTypeAnonymousInnerClass(XSCtrLibrary outerInstance)
			{
