...
namespace org.eclipse.wst.xml.xpath2.processor.@internal
{
	...
	/// </summary>
	public class StaticAttrNameError : StaticNameError
	{

		/// 
		private const long serialVersionUID = -5037788654293050262L;
		...
		public StaticAttrNameError(string reason) : base(reason)
		{
		}
	}
