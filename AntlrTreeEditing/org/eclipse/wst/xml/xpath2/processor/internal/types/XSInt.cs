...
namespace org.eclipse.wst.xml.xpath2.processor.@internal.types
{
	...
	public class XSInt : XSLong
	{
		...
		private const string XS_INT = "xs:int";

		/// <summary>
		/// Initializes a representation of 0
		/// </summary>
		public XSInt() : this(System.Numerics.BigInteger.Zero)
		{
		}
		...
		/// </summary>
		/// <param name="x">
		///            Int to be stored </param>
		public XSInt(System.Numerics.BigInteger x) : base(x)
		{
		}
		...
		/// </summary>
		/// <returns> "xs:int" which is the datatype's full pathname </returns>
		...
		/// </summary>
		/// <returns> "int" which is the datatype's name </returns>
