...
namespace org.eclipse.wst.xml.xpath2.processor.@internal.function
{
	...
	public class FnEndsWith : Function
	{
		...
		/// </summary>
		public FnEndsWith() : base(new QName("ends-with"), 2)
		{
		}
...
//ORIGINAL LINE: public org.eclipse.wst.xml.xpath2.api.ResultSequence evaluate(java.util.Collection args, org.eclipse.wst.xml.xpath2.api.EvaluationContext ec) throws org.eclipse.wst.xml.xpath2.processor.DynamicError
		...
		/// <exception cref="DynamicError">
		///             Dynamic error. </exception>
		/// <returns> Result of fn:ends-with operation. </returns>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static org.eclipse.wst.xml.xpath2.api.ResultSequence ends_with(java.util.Collection args) throws org.eclipse.wst.xml.xpath2.processor.DynamicError
		public static ResultSequence ends_with(ICollection args)
		{
			...
			return XSBoolean.valueOf(str1.EndsWith(str2, StringComparison.Ordinal));
		}
