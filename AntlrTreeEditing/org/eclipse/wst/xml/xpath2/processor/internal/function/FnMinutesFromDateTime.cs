...
namespace org.eclipse.wst.xml.xpath2.processor.@internal.function
{
	...
	/// </summary>
	public class FnMinutesFromDateTime : Function
	{
		...
		/// </summary>
		public FnMinutesFromDateTime() : base(new QName("minutes-from-dateTime"), 1)
		{
		}
...
//ORIGINAL LINE: public org.eclipse.wst.xml.xpath2.api.ResultSequence evaluate(java.util.Collection args, org.eclipse.wst.xml.xpath2.api.EvaluationContext ec) throws org.eclipse.wst.xml.xpath2.processor.DynamicError
		...
		/// <exception cref="DynamicError">
		///             Dynamic error. </exception>
		/// <returns> Result of fn:minutes-from-dateTime operation. </returns>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static org.eclipse.wst.xml.xpath2.api.ResultSequence minutes_from_date_time(java.util.Collection args) throws org.eclipse.wst.xml.xpath2.processor.DynamicError
		public static ResultSequence minutes_from_date_time(ICollection args)
		{
		...
		{
			lock (typeof(FnMinutesFromDateTime))
			{
