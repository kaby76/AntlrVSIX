...
namespace org.eclipse.wst.xml.xpath2.processor.@internal.types
{
	...
	public class SchemaTypeValueFactory
	{
		...
		public static AnyType newSchemaTypeValue(short typeDef, string strValue)
		{
			...
			//	return new XSBoolean(Convert.ToBoolean(newStrValue));
			//}
			...
			//{
			//	return new XSDecimal(new decimal(strValue));
			//}

			//if (typeDef == XSConstants.INTEGER_DT)
			//{
			//	return new XSInteger(new System.Numerics.BigInteger(strValue));
			//}

			//if (typeDef == XSConstants.LONG_DT)
			//{
			//	return new XSLong(new System.Numerics.BigInteger(strValue));
			//}

			//if (typeDef == XSConstants.INT_DT)
			//{
			//	return new XSInt(new System.Numerics.BigInteger(strValue));
			//}

			//if (typeDef == XSConstants.SHORT_DT)
			//{
			//	return new XSShort(new System.Numerics.BigInteger(strValue));
			//}

			//if (typeDef == XSConstants.BYTE_DT)
			//{
			//	return new XSByte(new System.Numerics.BigInteger(strValue));
			//}

			//if (typeDef == XSConstants.NONNEGATIVEINTEGER_DT)
			//{
			//	return new XSNonNegativeInteger(new System.Numerics.BigInteger(strValue));
			//}

			//if (typeDef == XSConstants.POSITIVEINTEGER_DT)
			//{
			//	return new XSPositiveInteger(new System.Numerics.BigInteger(strValue));
			//}

			//if (typeDef == XSConstants.UNSIGNEDLONG_DT)
			//{
			//	return new XSUnsignedLong(new System.Numerics.BigInteger(strValue));
			//}

			//if (typeDef == XSConstants.UNSIGNEDINT_DT)
			//{
			//	return new XSUnsignedInt(new System.Numerics.BigInteger(strValue));
			//}

			//if (typeDef == XSConstants.UNSIGNEDSHORT_DT)
			//{
			//	return new XSUnsignedShort(new System.Numerics.BigInteger(strValue));
			//}

			//if (typeDef == XSConstants.UNSIGNEDBYTE_DT)
			//{
			//	return new XSUnsignedByte(new System.Numerics.BigInteger(strValue));
			//}

			//if (typeDef == XSConstants.NONPOSITIVEINTEGER_DT)
			//{
			//	return new XSNonPositiveInteger(new System.Numerics.BigInteger(strValue));
			//}

			//if (typeDef == XSConstants.NEGATIVEINTEGER_DT)
			//{
			//	return new XSNegativeInteger(new System.Numerics.BigInteger(strValue));
			//}
			//// end of, decimal types

			//if (typeDef == XSConstants.DOUBLE_DT)
			//{
			//	return new XSDouble(double.Parse(strValue));
			//}
			...
			//{
			//	return new XSFloat(float.Parse(strValue));
			//}
