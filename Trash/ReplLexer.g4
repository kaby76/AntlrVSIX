...
DIFF : 'diff' -> pushMode(ArgMode) ;
DOT : 'dot' -> pushMode(ArgMode) ;
ECHO : 'echo' -> pushMode(ArgMode) ;
EXIT : 'exit' -> pushMode(ArgMode) ;
FOLD : 'fold' -> pushMode(ArgMode) ;
FOLDLIT : 'foldlit' -> pushMode(ArgMode) ;
GENERATE : 'generate' -> pushMode(ArgMode) ;
