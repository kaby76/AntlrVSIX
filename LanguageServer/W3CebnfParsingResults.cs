namespace LanguageServer
{
    ...
    internal class W3CebnfParsingResults : ParsingResults, IParserDescription
    {
        ...
        public override Func<IParserDescription, Dictionary<IParseTree, IList<CombinedScopeSymbol>>, IParseTree, int> Classify { get; } =
           (IParserDescription gd, Dictionary<IParseTree, IList<CombinedScopeSymbol>> st, IParseTree t) =>
           {
               ...
               else
               {
                   ...
                   if ((term.Symbol.Type == W3CebnfParser.STRING
                         || term.Symbol.Type == W3CebnfParser.SET
                         || term.Symbol.Type == W3CebnfParser.CONSTRAINT))
                   {
                       return (int)AntlrClassifications.ClassificationLiteral;
                   }
                    if (
                       term.Symbol.Type == W3CebnfParser.COMMENT)
                   {
        ...
        public override string FileExtension { get; } = ".ebnf";
