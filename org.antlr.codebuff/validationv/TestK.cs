...
//ORIGINAL LINE: public static void main(String[] args) throws Exception
		...
		{
			LangDescriptor[] languages = new LangDescriptor[] {JAVA_DESCR, JAVA8_DESCR, ANTLR4_DESCR, SQLITE_CLEAN_DESCR, TSQL_CLEAN_DESCR};
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static void writePython(org.antlr.codebuff.misc.LangDescriptor[] languages, java.util.List<Nullable<int>> ks, Float[][] medians) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public java.util.List<Nullable<float>> scoreDocuments() throws Exception
