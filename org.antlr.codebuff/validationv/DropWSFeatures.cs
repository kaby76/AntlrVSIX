...
//ORIGINAL LINE: public static void testFeatures(org.antlr.codebuff.misc.LangDescriptor[] languages, boolean includeAllFeatures) throws Exception
		public static void testFeatures(LangDescriptor[] languages, bool includeAllFeatures)
		{
			...
			foreach (LangDescriptor language in languages)
			{
				...
				IList<float?> errors = getWSErrorRates(language, injectWSFeatures, FEATURES_HPOS);
				errors.Sort();
				int n = errors.Count;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static java.util.List<Nullable<float>> getWSErrorRates(org.antlr.codebuff.misc.LangDescriptor language, org.antlr.codebuff.FeatureMetaData[] injectWSFeatures, org.antlr.codebuff.FeatureMetaData[] alignmentFeatures) throws Exception
		public static IList<float?> getWSErrorRates(LangDescriptor language, FeatureMetaData[] injectWSFeatures, FeatureMetaData[] alignmentFeatures)
		{
